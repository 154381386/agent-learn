...
ACTION_REGISTRY: dict[str, ActionRegistration] = {
    "rollback_deploy": ActionRegistration(
        ...
        parameter_types={"service": "string", "version": "string"},
    ),
    "restart_pods": ActionRegistration(
        ...
        parameter_types={"service": "string", "namespace": "string"},
    ),
    "scale_replicas": ActionRegistration(
        ...
        optional_params=(),
        parameter_types={"service": "string", "count": "integer"},
    ),
    "observe_service": ActionRegistration(
        ...
        required_params=("service",),
        optional_params=(),
        parameter_types={"service": "string"},
    ),
...
def build_approval_snapshot(*, action: str, risk: str, resource: str | None, params: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {**snapshot_payload, "snapshot_id": snapshot_id}
