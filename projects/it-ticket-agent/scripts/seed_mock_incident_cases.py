...
def build_cases() -> list[IncidentCase]:
    return [
        ...
        IncidentCase(
            ...
            action_pattern="cicd.rollback_release",
        ...
        IncidentCase(
            ...
            failure_mode="dependency_timeout",
            root_cause_taxonomy="network_path_instability",
            signal_pattern="upstream_unhealthy+timeout",
            action_pattern="observe_service",
        ...
        IncidentCase(
            ...
            failure_mode="db_pool_saturation",
            root_cause_taxonomy="database_degradation",
            signal_pattern="replication_lag+pool_saturation",
            action_pattern="observe_service",
        ...
        IncidentCase(
            ...
            namespace="default",
            current_agent="hypothesis_graph",
            failure_mode="runtime_signal_amplification",
            root_cause_taxonomy="runtime_signal_amplification",
            signal_pattern="alert_spike+thread_pool_queue",
            action_pattern="observe_service",
