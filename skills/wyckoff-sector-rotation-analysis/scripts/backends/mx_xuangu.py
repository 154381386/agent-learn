...
def main():
    ...
    parser.add_argument('--output-dir', dest='output_dir', help='输出目录，默认 skills/wyckoff-sector-rotation-analysis/scripts/backends/output/')
    ...
    # Default output directory is fixed to skills/wyckoff-sector-rotation-analysis/scripts/backends/output/
